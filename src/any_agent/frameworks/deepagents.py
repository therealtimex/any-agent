...
try:
    ...
    DEFAULT_AGENT_TYPE = create_deep_agent
...
class DeepAgentsAgent(AnyAgent):
    """DeepAgents agent implementation that handles both loading and running."""
    ...
    def framework(self) -> AgentFramework:
        return AgentFramework.DEEPAGENTS
    ...
    async def _load_agent(self) -> None:
        ...
        if not deepagents_available:
            msg = "You need to `pip install 'any-agent[deepagents]'` to use this agent"
